...
class TestFundAnalyzer:
    ...
    def test_parse_percentage_standard_cases(self, percentage_parsing_cases):
        ...
        for input_percentage, expected_output in percentage_parsing_cases:
            ...
            assert result == expected_output, f"Input: '{input_percentage}' -> Expected: {expected_output}, Got: {result}"
    ...
    def test_find_companies_in_all_funds_with_common_companies(self, mock_config_provider: ConfigProvider):
    ...
    def test_find_companies_in_all_funds_no_common_companies(self, mock_config_provider: ConfigProvider):
...
class TestFundAnalyzerFileProcessing:
    ...
    def test_process_single_fund_file_valid_file(self, mock_config_provider: ConfigProvider, 
                                                sample_fund_data: dict[str, Any], temp_directory: Path):
    ...
    def test_process_single_fund_file_invalid_file(self, mock_config_provider: ConfigProvider, 
                                                  temp_directory: Path):
